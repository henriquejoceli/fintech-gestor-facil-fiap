...
insert into t_tipoocorrenciacadastro (id, tipo, descricao, status) values (1, 'S', 'Alteração de senha', 'A');
insert into t_tipoocorrenciacadastro (id, tipo, descricao, status) values (2, 'L', 'Tentativa de login', 'A');
insert into t_tipoocorrenciacadastro (id, tipo, descricao, status) values (3, 'M', 'Manutenção cadastral', 'A');
insert into t_tipoocorrenciacadastro (id, tipo, descricao, status) values (4, 'E', 'Erro de integração', 'A');
insert into t_tipoocorrenciacadastro (id, tipo, descricao, status) values (5, 'O', 'Ocorrência manual', 'A');
insert into t_tipoocorrenciacadastro (id, tipo, descricao, status) values (6, 'T', 'Cadastro de transação', 'A');
insert into t_tipoocorrenciacadastro (id, tipo, descricao, status) values (7, 'I', 'Cadastro de investimento', 'A');
insert into t_tipoocorrenciacadastro (id, tipo, descricao, status) values (8, 'A', 'Atualização sobre transação', 'A');
insert into t_tipoocorrenciacadastro (id, tipo, descricao, status) values (9, 'B', 'Atualização sobre investimento', 'A');